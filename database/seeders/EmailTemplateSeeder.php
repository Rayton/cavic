    ...
    public function run() {
        $templates = [
            [
                "name"                => "Welcome Email",
                "slug"                => "WELCOME_EMAIL",
                "subject"             => "Welcome to Victech",
                "email_body"          => "<div class='content'> <h1>Welcome to Victech, {{customerName}}!</h1> <p>We're thrilled to have you onboard. 🚀</p> <p>Victech is your all-in-one HRM & Payroll system designed to streamline your business operations. With our powerful tools, you can manage:</p> <ul style='text-align: left; padding: 0 40px;'> <li><b>HR & Employee Management</b> – Track employee records & attendance.</li> <li><b>Payroll Processing</b> – Automate salary & tax calculations.</li> <li><b>Employee Self-Service Portal</b> – Access payslips, leave requests & more.</li> <li><b>Accounting & Finance</b> – Manage expenses, invoices & reports.</li> <li><b>Loan Management</b> – Handle employee loans with ease.</li> <li><b>Task & Project Management</b> – Assign, track, and collaborate.</li> </ul> <a href='{{loginLink}}' class='btn'>Login to Victech</a> <p>Need help? Contact our support team.</p> <p>Let's build a smarter workplace together!</p> </div>",
                "sms_body"            => "",
                "notification_body"   => "",
            ...
            [
                ...
                "slug"                => "DEPOSIT_REQUEST_SUBMITTED",
                "subject"             => "Deposit Request Submitted",
                "email_body"          => "<div>\r\n<div>Dear {{name}},</div>\r\n<div>Your deposit request of {{amount}} has been submitted successfully and is pending approval.</div>\r\n<div>&nbsp;</div>\r\n<div>Request ID: {{requestId}}</div>\r\n<div>Account Number: {{account_number}}</div>\r\n<div>Amount: {{amount}}</div>\r\n<div>Deposit Method: {{depositMethod}}</div>\r\n<div>Submitted on: {{dateTime}}</div>\r\n<div>&nbsp;</div>\r\n<div>Your request will be reviewed and you will be notified once it is processed.</div>\r\n</div>",
                "sms_body"            => "Dear {{name}}, Your deposit request of {{amount}} has been submitted successfully and is pending approval. Request ID: {{requestId}}",
                "notification_body"   => "Dear {{name}}, Your deposit request of {{amount}} has been submitted successfully and is pending approval.",
                "shortcode"           => "{{name}} {{account_number}} {{amount}} {{dateTime}} {{balance}} {{depositMethod}} {{requestId}} {{description}}",
                "email_status"        => 0,
                "sms_status"          => 0,
                "notification_status" => 0,
                "template_mode"       => 0,
