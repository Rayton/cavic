                ...
                <div class="card-body">
					...
					<form method="POST" class="form-signin" action="{{ url('/login') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="email" type="email" class="text-left form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" placeholder="{{ _lang('Email') }}" required autofocus>
