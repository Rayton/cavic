...
.workspace-stat-card .stat-value { font-size: 1.4rem; font-weight: 700; color: #1A8E8F; }
.workspace-stat-card .stat-link { font-size: .82rem; }
.workspace-nav .nav-link { border-radius: 8px; margin-right: .5rem; color: #495057; }
.workspace-nav .nav-link.active { background: #1A8E8F; color: #fff; }
...
.workspace-pill { display: inline-block; padding: .2rem .6rem; border-radius: 999px; background: #eef7f7; color: #1A8E8F; font-size: .75rem; font-weight: 600; }
...
.workspace-breadcrumbs a:hover { color: #1A8E8F; }
...
.workspace-bucket-card .bucket-value { font-size: 1.3rem; font-weight: 700; color: #1A8E8F; }
